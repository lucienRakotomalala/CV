...
\cvitem{Systèmes linéaire continu}{Analyse et conception de systèmes linéaire dynamique représentés par fonction différentielle ou fonction de transfert. \newline 
Applications de méthodes de discrétisation de systèmes ou de commande pour une implémentation sur carte programmable.}
\cvitem{Représentation d'état}{Réalisation d'espace d'état, analyse de systèmes et conception de commande par retour d'état basé observateur}
\cvitem{Systèmes Temps réel}{Analyse d'ordonnancement de tâche, programmation sur RTOS.}
\cvitem{Conception orienté objet}{}
...
\cvitemwithcomment{Programmation parallèle}{Langage C sur RTOS}{Avancé}
\cvdoubleitem{\'Editeur de texte}{Microsoft Office et \LaTeX}{OS}{\faLinux, \faWindows}
\cvitemwithcomment{Git}{Suivi de projet avec GitHub via l'interface graphique GitKraken}{Intermédiaire}
